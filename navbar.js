document.write(`
<div style="color: white; height: 110px; padding: 0 3%; background-color: #81182d;">
    <a href="index.html">
        <img src="img/StarJobs.gif" alt="Logo Star Jobs" height="100px" width="100px"  style=" float: left; border-radius: 90px; margin-top:6px;">
    </a>

    <div class="botoes"  style="float: right; height: 100%; padding: 40px 0; ">
        <a href="#" class="botao-azul" id="myBtn" style="font-size: 1.5em; margin-right: 15px;  ">CADASTRAR</a>
        <a href="#" class="botao-verde" id="myBtn2" style="font-size: 1.5em; margin-right: 10px;">LOGAR</a>
    </div>
